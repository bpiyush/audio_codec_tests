"""
Original: https://github.com/v-iashin/SparseSync/blob/2a61d0bba652475a72f443c7b134607245d17f77/dataset/transforms.py
...
class AudioTimeCrop(torch.nn.Module):
    ...
    def forward(self, item):
        ...
        label = int(np.ceil((a_left_i / a_fps) / 0.1))
        label = min(max(label, 1), 50)
